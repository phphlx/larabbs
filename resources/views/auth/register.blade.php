      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
              <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }} / 手机号</label>

              <div class="col-md-6">
                <input id="email" type="text" class="form-control{{ ($errors->has('email') || $errors->has('phone')) ? '
